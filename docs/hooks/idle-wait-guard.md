...
Blocks commands made entirely of waiting or fixed output, such as `sleep 600; echo done` or `echo ok`. These commands
can fill agent turns without advancing the task. The denial explains how to wait for the actual operation instead.
